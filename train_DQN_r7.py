...
DQN_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/r7",            # experiment's parent directory
        "experiment_name": "DQN_Terrain_Rooms_r7_long",      # experiment name
        ...
        "wandb_kwargs": {"project":     "RL-Terrain-Simulation",
                        ...
                        "name":         "DQN_Terrain_Rooms_r7_long",
                        "tags":         ["DQN", "Rooms"],
