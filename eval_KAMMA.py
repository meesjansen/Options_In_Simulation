...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_FIFO_curr1_seed2_eval",
        "experiment_name": "KAMMA_FIFO_curr1_seed2_eval",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "KAMMA",
                         ...
                         "name": "KAMMA_FIFO_curr1_seed2_eval",
...
agent.load("./my_runs/KAMMA_FIFO_curr1_seed2/KAMMA_FIFO_curr1_seed2/checkpoints/agent_500000.pt")
