...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_FIFO_curr1_seed5_eval",
        "experiment_name": "KAMMA_FIFO_curr1_seed5_eval",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "KAMMA",
                         ...
                         "name": "KAMMA_FIFO_curr1_seed5_eval",
