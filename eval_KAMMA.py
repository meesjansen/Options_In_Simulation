...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_eval_seed4",
        "experiment_name": "KAMMA_eval_seed4",
        "write_interval": "auto",
...
agent.load("./my_runs/KAMMA_seed4/KAMMA_seed4/checkpoints/agent_500000.pt")
