...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_FIFO_curr2_seed4_eval",
        "experiment_name": "KAMMA_FIFO_curr2_seed4_eval",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "KAMMA",
                         ...
                         "name": "KAMMA_FIFO_curr2_seed4_eval",
...
agent.load("./my_runs/KAMMA_FIFO_curr2_seed4/KAMMA_FIFO_curr2_seed4/checkpoints/agent_500000.pt")
