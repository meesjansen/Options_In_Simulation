...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_eval_seed3",
        "experiment_name": "KAMMA_eval_seed3",
        "write_interval": "auto",
...
agent.load("./my_runs/KAMMA_seed3/KAMMA_seed3/checkpoints/agent_500000.pt")
