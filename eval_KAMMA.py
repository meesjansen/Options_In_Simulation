...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_eval_seed1",
        "experiment_name": "KAMMA_eval_seed1",
        "write_interval": "auto",
...
agent.load("./my_runs/KAMMA_medium/KAMMA_medium/checkpoints/agent_500000.pt")
