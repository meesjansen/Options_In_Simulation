...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_curr1_seed4_eval",
        "experiment_name": "KAMMA_curr1_seed4_eval",
        "write_interval": "auto",
...
agent.load("./my_runs/KAMMA_curr1_seed4/KAMMA_curr1_seed4/checkpoints/agent_500000.pt")
