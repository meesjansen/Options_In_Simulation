...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_curr1_seed3_eval",
        "experiment_name": "KAMMA_curr1_seed3_eval",
        "write_interval": "auto",
...
agent.load("./my_runs/KAMMA_curr1_seed3/KAMMA_curr1_seed3/checkpoints/agent_500000.pt")
