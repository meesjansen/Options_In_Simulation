...
class TorqueDistributionTask(RLTask):
    def __init__(self, name, sim_config, env, offset=None) -> None:
       ...
       # --- KA-DDPG/KA-PPO modifications: use a state space of 4 and action space of 4 ---
        ...
        self.max_global_episodes = 1200.0
        self.max_sim_steps = 1200000.0 # 250 episodes of 10s at 100Hz sim and 10Hz control/policy step
        # ---------------------------------------------------------------------------
    ...
    def get_observations(self):
        ...
        self.observed_components = {
                    ...
                    "env0_policy_torque_fl": self.actions[0, 0].item(),
                    "env0_policy_torque_rl": self.actions[0, 1].item(),
                    "env0_policy_torque_fr": self.actions[0, 2].item(),
                    "env0_policy_torque_rr": self.actions[0, 3].item(),
