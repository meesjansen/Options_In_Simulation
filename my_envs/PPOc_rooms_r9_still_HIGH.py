...
class ReachingTargetTask(RLTask):
    ...
    def is_done(self):
        ...
        still_lin = (self.base_vel[:, 0].abs() < 0.1)
        still_ang = (self.base_ang_vel[:, 2].abs() < 0.1)
    ...
    def calculate_metrics(self) -> None:
        ...
        self.still_lin = self.base_vel[:, 0].abs() < 0.2 
        self.still_ang = self.base_ang_vel[:, 2].abs() < 0.2
