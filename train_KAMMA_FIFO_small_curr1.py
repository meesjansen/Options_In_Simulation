...
from my_envs.KAMMA_curr1 import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_FIFO_small_curr1",
        "experiment_name": "KAMMA_FIFO_small_curr1",
        "write_interval": "auto",
