...
from my_envs.PPOc_terrain_r5 import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_r62",            # experiment's parent directory
        "experiment_name": "PPOc_r62",      # experiment name
