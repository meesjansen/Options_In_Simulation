...
from my_envs.PPOc_terrain_r4_v22 import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_r3",            # experiment's parent directory
        "experiment_name": "PPOc_r3",      # experiment name
