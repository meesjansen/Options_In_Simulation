...
from my_envs.KA_DDPG_r18_high_fid_curr import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_r18_high_fid_curr",
        "experiment_name": "KA-DDPG_r18_high_fid_curr",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "Expert Knowledge final",
                         ...
                         "name": "KA-DDPG_r18_high_fid_curr",
