...
from my_envs.KA_DDPG_r18_se_short_r_g1 import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_r18_se_short_r_g1",
        "experiment_name": "KA-DDPG_r18_se_short_r_g1",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "Expert Knowledge Variations",
                         ...
                         "name": "KA-DDPG_r18_se_short_r_g1",
