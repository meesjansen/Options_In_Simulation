...
class Policy(GaussianMixin, Model):
    def __init__(self, observation_space, action_space, device, clip_actions=True,
                 clip_log_std=True, min_log_std=-20, max_log_std=-8):
...
from my_envs.PPOc_rooms_r9_log_std_LOW import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_rooms_r9_log_std_LOW",            # experiment's parent directory
        "experiment_name": "PPOc_rooms_r9_log_std_LOW",      # experiment name
        ...
        "wandb_kwargs": {"project":     "PPO_rooms",
                        ...
                        "name":         "PPOc_rooms_r9_log_std_LOW",
                        "tags":         ["PPOc", "Rooms"],
