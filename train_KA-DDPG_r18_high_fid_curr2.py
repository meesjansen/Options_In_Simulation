...
from my_envs.KA_DDPG_r18_high_fid_curr2 import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_r18_high_fid_curr2",
        "experiment_name": "KA-DDPG_r18_high_fid_curr2",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "Expert Knowledge final",
                         ...
                         "name": "KA-DDPG_r18_high_fid_curr2",
