...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_GV_eval",
        "experiment_name": "KAMMA_GV_eval",
        "write_interval": "auto",
...
agent.load("./my_runs/KAMMA_curr1/KAMMA_curr1/checkpoints/agent_500000.pt")
