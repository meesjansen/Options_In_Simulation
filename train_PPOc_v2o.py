...
from my_envs.PPOc_terrain_v2o import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_v2o",            # experiment's parent directory
        "experiment_name": "PPOc_v2o",      # experiment name
