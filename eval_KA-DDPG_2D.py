...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA_DDPG_2D_eval_seed4",
        "experiment_name": "KA_DDPG_2D_eval_seed4",
        "write_interval": "auto",
...
agent.load("./my_runs/KA-DDPG_2D_seed4/KA-DDPG_2D_seed4/checkpoints/agent_700000.pt")
