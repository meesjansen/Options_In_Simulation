...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA_DDPG_2D_eval_seed1",
        "experiment_name": "KA_DDPG_2D_eval_seed1",
        "write_interval": "auto",
...
agent.load("./my_runs/KA-DDPG_2D_seed1/KA-DDPG_2D_seed1/checkpoints/agent_700000.pt")
