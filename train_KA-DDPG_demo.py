...
from my_envs.KA_DDPG_demo_copy import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_1D",
        "experiment_name": "KA-DDPG_1D",
        "write_interval": "auto",
