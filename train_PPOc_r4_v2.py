...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_r4_v2",            # experiment's parent directory
        "experiment_name": "PPOc_r4_v2",      # experiment name
