...
from my_envs.DQN_terrain_r3 import ReachingTargetTask, TASK_CFG
...
DQN_DEFAULT_CONFIG = {
    ...
    "exploration": {
        ...
        "timesteps": 0,            # timesteps for epsilon-greedy decay
    },
    ...
    "experiment": {
        ...
        "experiment_name": "Eval",      # experiment name
...
agent.load("./my_runs/r3/DQN_Terrain_Rooms_r3_long/checkpoints/agent_250000.pt")
