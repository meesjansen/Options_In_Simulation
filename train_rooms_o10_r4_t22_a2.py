...
from my_envs.PPOc_rooms_o10_r4_t22_a2 import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_rooms_o10_r4_t22_a2",            # experiment's parent directory
        "experiment_name": "PPOc_rooms_o10_r4_t22_a2",      # experiment name
...
cfg_ppo["random_timesteps"] = 5
cfg_ppo["learning_starts"] = 6 # cfg_ppo["rollouts"] * env.num_envs * 4
