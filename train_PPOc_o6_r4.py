...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_06_r4",            # experiment's parent directory
        "experiment_name": "PPOc_o6_r4",      # experiment name
