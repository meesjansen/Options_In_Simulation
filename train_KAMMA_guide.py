...
from my_envs.KAMMA_guide import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_guide",
        "experiment_name": "KAMMA_guide",
        "write_interval": "auto",
