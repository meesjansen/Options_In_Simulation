...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA_DDPG_1D_eval_seed2",
        "experiment_name": "KA_DDPG_1D_eval_seed2",
        "write_interval": "auto",
...
agent.load("./my_runs/KA-DDPG_1D_seed2/KA-DDPG_1D_seed2/checkpoints/agent_700000.pt")
