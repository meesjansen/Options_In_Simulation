...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA_DDPG_1D_eval_seed3",
        "experiment_name": "KA_DDPG_1D_eval_seed3",
        "write_interval": "auto",
...
agent.load("./my_runs/KA-DDPG_1D_seed3/KA-DDPG_1D_seed3/checkpoints/agent_700000.pt")
