...
from my_envs.PPOc_rooms_r9_timesteps_HIGHER import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_rooms_r9_timesteps_HIGHER",            # experiment's parent directory
        "experiment_name": "PPOc_rooms_r9_timesteps_HIGHER",      # experiment name
        ...
        "wandb_kwargs": {"project":     "PPO_rooms",
                        ...
                        "name":         "PPOc_rooms_r9_timesteps_HIGHER",
                        "tags":         ["PPOc", "Rooms"],
