...
print("Observation Space: ", env.observation_space, env.action_space, env.observation_space.type)
print("Action Space: ", env.action_space, env.action_space.shape, env.action_space.type)
