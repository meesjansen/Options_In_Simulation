...
from my_envs.PPOc_rooms_r15_ang_vel import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_rooms_r15_ang_vel",            # experiment's parent directory
        "experiment_name": "PPOc_rooms_r15_ang_vel",      # experiment name
        ...
        "wandb_kwargs": {"project":     "PPO_curriculum",
                        ...
                        "name":         "PPOc_rooms_r15_ang_vel",
                        "tags":         ["PPOc", "Curriculum", "r15", "o163", "vel", "RL control"],
