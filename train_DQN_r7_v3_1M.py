...
DQN_DEFAULT_CONFIG = {
    ...
    "exploration": {
        ...
        "timesteps": 250_000,            # timesteps for epsilon-greedy decay
    },

    "rewards_shaper": None,         # rewards shaping function: Callable(reward, timestep, timesteps) -> reward

    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/r7_1M",            # experiment's parent directory
        "experiment_name": "DQN_Terrain_Rooms_r7_v4_1M",      # experiment name
        ...
        "wandb_kwargs": {"project":     "RL-Terrain-Simulation",
                        ...
                        "name":         "DQN_Terrain_Rooms_r7_v4_1M",
                        "tags":         ["DQN", "Rooms"],
