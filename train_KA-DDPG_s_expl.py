...
from my_envs.KA_DDPG_s_expl import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_s_expl",
        "experiment_name": "KA-DDPG_s_expl",
        "write_interval": "auto",
