...
from my_envs.KA_DDPG_r18_high_fid_7_vel import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_r18_high_fid_7_vel",
        "experiment_name": "KA-DDPG_r18_high_fid_7_vel",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "Expert Knowledge 1-to-1",
                         ...
                         "name": "KA-DDPG_r18_high_fid_7_vel",
