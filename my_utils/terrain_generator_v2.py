...
import numpy as np
import torch
from my_utils.terrain_utils_v2 import *
...
class Terrain:
    def __init__(self, num_robots, terrain_type) -> None:
        ...
        # Compute and store the normal maps
        self.normal_map_x, self.normal_map_y, self.normal_map_z = compute_normal_map(
            self.height_field_raw, self.horizontal_scale, self.vertical_scale
        )
    ...
    def cr_env(self, terrain_type):
        for k in range(self.num_maps):
            ...
            if terrain_type == "double room":
                ...
                custom_sloped_terrain(terrain, height_steps=0.08, slope=.3, platform_size=1.0)
