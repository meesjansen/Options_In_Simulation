    ...
    def cr_env(self, terrain_type):
        for k in range(self.num_maps):
            ...
            if terrain_type == "rooms":
                rooms_terrain(terrain, wall_height=1.0, wall_thickness=.2, passage_width=4.0)
            if terrain_type == "single room":
                rooms_terrain2(terrain, wall_height=1.0, wall_thickness=.2, passage_width=5.0)
