...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/kaddpg_2d_nofifo_random_RLIL",
        "experiment_name": f"kaddpg_2d_nofifo_random_RLIL_s{seed}",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "KA-DDPG Dimension Study",
                         ...
                         "name": f"kaddpg_2d_nofifo_random_RLIL_s{seed}",
