...
from my_envs.KAMMA_medium import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/kamma_4d_nofifo_random_RLIL",
        "experiment_name": f"kamma_4d_nofifo_random_RLIL_s{seed}",
        "write_interval": "auto",
        ...
        "wandb_kwargs": {"project": "KAMMA",
                         ...
                         "name": f"kamma_4d_nofifo_random_RLIL_s{seed}",
