...
from my_envs.KA_DDPG_m_vobs import TorqueDistributionTask, TASK_CFG
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_m_vobs",
        "experiment_name": "KA-DDPG_m_vobs",
        "write_interval": "auto",
