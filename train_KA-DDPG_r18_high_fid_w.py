...
arg_parser.add_argument("--stiffness", type=float, default=0.006) 
...
arg_parser.add_argument("--linear_x", type=float, default=[0.8, 1.2]) # 0.8, 1.2
arg_parser.add_argument("--yaw", type=float, default=[1.3, 1.7])
