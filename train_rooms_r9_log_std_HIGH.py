...
class Policy(GaussianMixin, Model):
    def __init__(self, observation_space, action_space, device, clip_actions=True,
                 clip_log_std=True, min_log_std=-10, max_log_std=-5):
...
from my_envs.PPOc_rooms_r9_log_std_HIGH import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_rooms_r9_log_std_HIGH",            # experiment's parent directory
        "experiment_name": "PPOc_rooms_r9_log_std_HIGH",      # experiment name
        ...
        "wandb_kwargs": {"project":     "PPO_rooms",
                        ...
                        "name":         "PPOc_rrooms_r9_log_std_HIGH",
                        "tags":         ["PPOc", "Rooms"],
