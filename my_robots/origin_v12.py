...
class AvularOrigin_v10(Robot):
    def __init__(
        ...
        if self._usd_path is None:
            self._usd_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "my_assets/urdf/origin_v12", "origin_v12.usd"))
        ...
        self._dof_names = [
                "left_front_passive_arm_v11",
                "right_front_passive_arm_v11",
                "left_rear_passive_arm_v11",
                "right_rear_passive_arm_v11",
                "left_front_wheel",
                "left_rear_wheel",
                "right_front_wheel",
                "right_rear_wheel",
