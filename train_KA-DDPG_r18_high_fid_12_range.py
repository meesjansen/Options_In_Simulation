...
from my_envs.KA_DDPG_r18_high_fid_12_range import TorqueDistributionTask, TASK_CFG
...
arg_parser.add_argument("--linear_x", type=float, default=[1.3, 1.7])
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_r18_high_fid_12",
        "experiment_name": "KA-DDPG_r18_high_fid_12",
        "write_interval": "auto",
