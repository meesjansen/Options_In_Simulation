...
from my_envs.KAMMA_xshort import TorqueDistributionTask, TASK_CFG
...
memory = FIFOMemory(memory_size=2_500, num_envs=env.num_envs, device=device, replacement=False)   # FIFO behaviour
...
DDPG_DEFAULT_CONFIG = {
    ...
    "exploration": {
        ...
        "timesteps": 100000.0,          # timesteps for the noise decay
    },
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KAMMA_FIFO_small_xshort",
        "experiment_name": "KAMMA_FIFO_small_xshort",
        "write_interval": "auto",
