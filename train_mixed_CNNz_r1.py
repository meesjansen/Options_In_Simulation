...
from my_envs.PPOc_mixed_CNNz_r1 import ReachingTargetTask, TASK_CFG
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_mixed_CNNz_r1",            # experiment's parent directory
        "experiment_name": "PPOc_mixed_CNNz_r1",      # experiment name
