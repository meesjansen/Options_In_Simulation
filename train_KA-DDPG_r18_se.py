...
arg_parser.add_argument("--linear_x", type=float, default=[0.5, 1.5])
...
cfg["exploration"]["noise"] = OrnsteinUhlenbeckNoise(theta=0.15, sigma=0.06, base_scale=0.3, device=device)
