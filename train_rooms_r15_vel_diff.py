...
from my_envs.PPOc_rooms_r15_vel_diff import ReachingTargetTask, TASK_CFG
...
arg_parser.add_argument("--actionScale", type=float, default=1.0)
arg_parser.add_argument("--deltaActionScale", type=float, default=1.0)
...
PPO_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/PPOc_rooms_r15_vel_diff",            # experiment's parent directory
        "experiment_name": "PPOc_rooms_r15_vel_diff",      # experiment name
        ...
        "wandb_kwargs": {"project":     "PPO_curriculum",
                        ...
                        "name":         "PPOc_rooms_r15_vel_diff",
                        "tags":         ["PPOc", "Curriculum", "r15", "o161", "vel", "vel_diff"],
