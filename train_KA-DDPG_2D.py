...
memory = FIFOMemory(memory_size=200_000, num_envs=env.num_envs, device=device, replacement=False)   # FIFO behaviour
...
DDPG_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/KA-DDPG_2D",
        "experiment_name": "KA-DDPG_2D",
        "write_interval": "auto",
