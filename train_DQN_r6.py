...
DQN_DEFAULT_CONFIG = {
    ...
    "experiment": {
        "directory": "/workspace/Options_In_Simulation/my_runs/r6",            # experiment's parent directory
        "experiment_name": "DQN_Terrain_Rooms_r6_long",      # experiment name
        ...
        "wandb_kwargs": {"project":     "RL-Terrain-Simulation",
                        ...
                        "name":         "DQN_Terrain_Rooms_r6_long",
                        "tags":         ["DQN", "Rooms"],
